...
<div class="grid p-8 grid place-items-start border-2 rounded-lg border-gray-300 hover:border-gray-700">
	<img class="h-40 place-self-center object-contain" src={product.imageUrl} alt={product.name} />
	<a class="font-bold mt-4" href={product.url}>{product.name}</a>
